...
columns_to_encode = rph_get_columns_to_encode(X, 30)
...
encoded_columns_to_drop = ['RoofStyle', 'FireplaceQu', 'Fence']
for column in encoded_columns_to_drop: columns_to_encode.remove(column)


columns_to_drop = columns_to_drop + encoded_columns_to_drop
